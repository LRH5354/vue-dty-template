...
ObjTree class is a parser/generater between XML source code
...
=head2 xotree = new ObjTree()

This constructor method returns a new ObjTree object.
...
;(function(global){
    function factory() { 
     ...
     typeof define === 'funtion' && (define.cmd || define.amd)? define(factory):
     (global.ObjTree=factory())
